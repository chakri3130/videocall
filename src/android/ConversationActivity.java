...
//        inflater.inflate(R.menu.menu_video_activity, menu);
    ...
    private void connectToRoom(String roomName) {
        ...
        ConnectOptions.Builder connectOptionsBuilder = new ConnectOptions.Builder(accessToken)
                .roomName(roomName);
        Analytics.trackEvent("Video call joined");
        /*
        ...
        if (encodingParameters != null)
            ...
            connectOptionsBuilder.encodingParameters(getEncodingParameters());
        }
    ...
    private void addRemoteParticipant(RemoteParticipant remoteParticipant) {
        ...
        Analytics.trackEvent("Both Parcipants joined");
    ...
    private void removeRemoteParticipant(RemoteParticipant remoteParticipant) {
        ...
        Analytics.trackEvent("Parcipant left the room");
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                Analytics.trackEvent("Waiting for the participant");
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                ...
                Analytics.trackEvent("Twilio exception occured" + e);
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                Analytics.trackEvent("Disconnected from Participant");
